...
public class UserTypeDAOImpl implements UserTypeDAO {
    ...
    public UserTypeDTO findById(Integer id) throws SQLException {
        ...
        return UserTypeDTO.builder().id(userTypeId).typeName(typeName).description(description).build();
    }
    ...
    public UserTypeDTO findByTypeName(String typeName) throws SQLException {
        ...
        String description = resultSet.getString("description");
        return UserTypeDTO.builder().id(id).typeName(userTypeName).description(description).build();
    }
}
